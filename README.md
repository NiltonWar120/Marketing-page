...
```
├── public/
│   ├── favicon.svg                # Svg que representa el logo de la empresa
├── src/
│   ├── components/             # Cursor, Footer, HeroCanvas, Navbar, ...
│   ├── Sections/               # Hero, About, Benefits, Process, Services,Testimonials, ...
│   ├── Stiles/                 # Componente dee stilos   
...
4. Abre el enlace del servidor en tu navegador y navega por las secciones.
...
- **Email**: guerraramireznilton@gmail.com
- **GitHub**: https://github.com/NiltonWar120
- **LinkedIn**: https://www.linkedin.com/in/nilthon-guerra-648457285/
- **WhatsApp**: +51 959272339
...
*Desarrollado con 💚 para mostrar trayectoria, estilo visual y calidad en el desarrollo de software*
